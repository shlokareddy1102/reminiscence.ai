...
import DailyRecallSession from "@/components/patient/DailyRecallSession";
...
const PatientHome = () => {
  ...
  useEffect(() => {
    const loadPatientData = async () => {
      try {
        const previewPatientId = getPatientPreviewId();
        const patient = await apiRequest(previewPatientId ? `/api/patient/${previewPatientId}` : "/api/patient");
